...
import { Activity, Building2, ClipboardCheck, Inbox, UploadCloud, LayoutDashboard, Shuffle } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/routing", label: "Metro Routing", icon: Shuffle },
